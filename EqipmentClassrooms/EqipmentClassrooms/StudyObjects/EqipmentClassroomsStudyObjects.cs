...
namespace EqipmentClassrooms.StudyObjects
{
    public partial class EqipmentClassroomsStudyObjects
    {
        ...
        {
            AB = new Audience("301", "Інформатика", "o") { };
            AC = new Audience("303","Географія","o") { };
            AD = new Audience("14", "Програмування", "o") { };
            AA = new Audience("16", "Англійська Мова", "o");
        }
        ...
        {
            Desk = new Eqipment("Доска",new DateTime(2014, 1, 1),"Рік виготовлення","o");
            Chair = new Eqipment("Стільці",new DateTime(2010, 1, 1),"Рік виготовлення", "o");
            Board = new Eqipment("Дошка", new DateTime(2011, 1, 1), "Рік виготовлення","o");
            Computer = new Eqipment("Компютер",new DateTime(2013, 1, 1),"Рік виготовлення","o");
            Keyboard = new Eqipment("Клавіатура",new DateTime(2011, 1, 1), "Рік виготовлення", "o");
            Mous = new Eqipment("Мишка",new DateTime(2009, 1, 1), "Рік виготовлення", "o");
            Paper = new Eqipment("Папір",new DateTime(2017, 1, 1), "Рік виготовлення", "o");
            Marker = new Eqipment("Маркер",new DateTime(2016, 1, 1), "Рік виготовлення", "o");
            Progector = new Eqipment("Проектор",new DateTime(2013, 1, 1),"Рік виготовлення", "o");
        }
        private void CreateEqipmentAudience()
        {
            Extinguisher = new EqipmentAudience("Extinguisher", "Вогнегасник\n")
            {
                ...
                Note="/nВогнега́сник — технічний засіб, призначений для припинення горіння\n"+
