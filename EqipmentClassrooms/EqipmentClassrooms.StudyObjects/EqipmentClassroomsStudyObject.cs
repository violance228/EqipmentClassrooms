...
//        {
//            Desk = new Eqipment("Доска", new DateTime(2014, 1, 1), "Рік виготовлення", "dfsfds");
//            Chair = new Eqipment("Стільці", new DateTime(2010, 1, 1), "Рік виготовлення","sa");
//            Board = new Eqipment("Дошка", new DateTime(2011, 1, 1), "Рік виготовлення", "scs");
//            Computer = new Eqipment("Компютер", new DateTime(2013, 1, 1), "Рік виготовлення", "sasa");
//            Keyboard = new Eqipment("Клавіатура", new DateTime(2011, 1, 1), "Рік виготовлення", "saf");
//            Mous = new Eqipment("Мишка", new DateTime(2009, 1, 1), "Рік виготовлення", "sad");
//            Paper = new Eqipment("Папір", new DateTime(2017, 1, 1), "Рік виготовлення", "dsq");
//            Marker = new Eqipment("Маркер", new DateTime(2016, 1, 1), "Рік виготовлення", "asd");
//            Progector = new Eqipment("Проектор", new DateTime(2013, 1, 1), "Рік виготовлення", "qw");
//        }
